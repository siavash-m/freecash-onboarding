...
function GenreCard({ opt, index, isSelected, anySelected, onSelect }: GenreCardProps) {
...
export function GameGenreBody({ onSelect, onSkip }: GameGenreBodyProps) {
