...
// ── Types ─────────────────────────────────────────────────────────────────────
type PaymentId = 'paypal' | 'bank' | 'crypto' | 'amazon';
...
const OPTIONS: PaymentOption[] = [
  { id: 'paypal',  icon: ASSETS.paypalLogo,  sub: 'Fast & instant',    name: 'Paypal'        },
  { id: 'bank',    icon: ASSETS.bankIcon,    sub: 'Direct to account',  name: 'Bank Transfer' },
  { id: 'crypto',  icon: ASSETS.bitcoinIcon, sub: 'Bitcoin & more',     name: 'Crypto'        },
  { id: 'amazon',  icon: ASSETS.amazonLogo,  sub: 'Gift cards',         name: 'Amazon'        },
];

// ── PaymentCard sub-component ─────────────────────────────────────────────────
...
export function PaymentMethodBody({ onSelect, onSkip, prevAnswer, onNext }: PaymentMethodBodyProps) {
  ...
  return (
    <div data-body="payment" className="flex flex-col flex-1 items-center justify-between px-[18px] pt-[20px] pb-[48px]">
      ...
      >
        ...
        <div className="flex flex-col gap-[6px] w-full">
          <p className="font-poppins font-medium text-[16px] text-[#a9a9ca] leading-normal w-full">
            We'll set this up before your first reward.
          </p>
